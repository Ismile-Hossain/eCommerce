    ...
    <div class="account-page">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-8">
                    @foreach (array_chunk($returnProducts, 3) as $chunk)
                        <div class="row">
                            @foreach ($chunk as $product)
                                <div class="col-md-4 col-sm-6 col-12" style="padding: 10px;">
                                    {{-- Show only the first image for each product --}}
                                    @if (!empty($product['images'][0]))
                                        <img src="{{ asset($product['images'][0]) }}" width="150" height="150"
